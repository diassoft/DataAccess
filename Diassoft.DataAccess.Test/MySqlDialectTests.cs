...
namespace Diassoft.DataAccess.Test
{
    ...
    public class MySqlDialectTests
    {
        ...
        [TestMethod]
        public void TestSelectDbOperation_015_SelectInto()
        {
            // Initializes the Select Statement
            SelectDbOperation select = new SelectDbOperation(new Table("testtable", "dbo", "0"));
        ...
        [TestMethod]
        public void TestInsertDbOperation_004_InsertWithSelect()
        {
            // Initializes the Insert Statement
            InsertDbOperation insert = new InsertDbOperation(new Table("testtable", "dbo", "0"))
            {
                Assignments = new AssignExpression[]
                {
                    new AssignExpression(new Field("field1"),null),
                    new AssignExpression(new Field("field2"),null),
                    new AssignExpression(new Field("field3"),null),
                    new AssignExpression(new Field("field4"),null),
                }
            };

            // Initializes the Select Statement
            SelectDbOperation select = new SelectDbOperation(new Table("testselecttable", "dbo", "0"))
            {
                SelectFields = new FieldCollection()
                {
                    new DisplayField("field1", "0"),
                    new DisplayField("field2", "0"),
                    new DisplayField("field3", "0"),
                    new DisplayField("field4", "0"),
                }
            };
